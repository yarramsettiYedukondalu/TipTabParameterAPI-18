...
//  TipTap
//
//  Created by yarramsetti yedukondalu on 11/11/23.
//
//
//import UIKit
//
...
////        
////        // Convert the URL string back to URL
////        if let userProfilePicUrlString = userProfilePicUrlString,
////           let userProfilePicUrl = URL(string: userProfilePicUrlString) {
////            // Now you can use userEmail, userFullName, userFamilyName, and userProfilePicUrl
////            userNameLabel.text = userFName + " " + userLName
////            userEmailLabel.text = userEmail
////            //            let initialsLabel = userFullName?.first?.lowercased()
////            //            let systemImageName = "\(initialsLabel ?? "")" + ".circle"
////            //
////            //            // Create a circular image with the label
////            //            if let originalImage = UIImage(systemName: systemImageName)?.withRenderingMode(.alwaysTemplate) {
////            //                // Set the tint color
////            //
////            //                var resizedImage = originalImage.resized(to: CGSize(width: 35, height: 35))
////            //                resizedImage = resizedImage.withTintColor(sourceColor.viewBackgroundColor)
////            //                userProfileImage .image = resizedImage
////            //
////            //            }
...
////            // print("User Profile Pic URL: \(userProfilePicUrl)")
////        }
////    }
//    
//    func setuserNameFromUserDefaults(){
...
//                userEmailLabel.text = userEmail
//       
//            if let base64String = UserDefaults.standard.string(forKey: "userProfilePicUrl") {
