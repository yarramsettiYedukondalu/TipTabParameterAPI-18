...
//  WFM
//
//  Created by Touqueir Ahmad on 14/07/22.
//
//
//import UIKit
...
////            UserNameLabel.text =  userFName + " " + userLName
////            userEmailLabel.text = userEmail
////            userPhoneNumberLabel.text =  "XXXXXXXXXXX"
...
//        userPhoneNumberLabel.text = userEmail
//        
//        // Convert the base64 string back to image data
...
//            }
//        } else {
//            print("Invalid base64 string for profile image")
//        }
//        
//        print("User Email: \(userEmail ?? "")")
//        print("User Full Name: \(userFullName ?? "")")
