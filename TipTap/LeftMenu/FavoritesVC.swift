...
////                        }
////                    }
////                    if let restaurantID = favoriteRestaurant.restaurant.RestaurantID {
////                        
////                        
...
////                    cell.favouriteButton.setImage(UIImage(systemName: "heart.fill"), for: .normal)
////                    cell.isFavourite = true
////                    if let restaurantCategory = favoriteRestaurant.restaurant.RestaurantCategory {
////                        cell.dishNames.text = restaurantCategory
////                    } else {
////                        cell.dishNames.text = "Unknown Category"
////                    }
////                    if let discount = favoriteRestaurant.rstaurantOffers?.discount {
////                        cell.offertypeLabel.text = "\(discount)"
////                    } else {
////                        cell.offertypeLabel.text = "0"
////                    }
////                    if let offerTitle = favoriteRestaurant.rstaurantOffers?.offerTitle {
////                        cell.offerLabel.text = offerTitle
////                    } else {
////                        cell.offerLabel.text = "No Offer"
////                    }
////                    if let desc = favoriteRestaurant.restaurant.Description {
////                        cell.descriLabels.text = desc
////                    } else {
////                        cell.descriLabels.text = "No Description"
////                    }
////                    
////                    if let title = favoriteRestaurant.restaurant.RestaurantTitle {
////                        cell.restaruntName.text = title
////                    } else {
////                        cell.restaruntName.text = "Unknown Restaurant"
////                    }
////                    if let restaurantAverageRating = favoriteRestaurant.restaurantAverageRating {
////                        cell.ratingLabel.text = "\(restaurantAverageRating) (\(favoriteRestaurant.restaurantRatings.count))"
////                    } else {
...
////                    
////                } else {
////                    // Populate cells for favorite items
////                    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "favCellPop", for: indexPath) as! favCollectionViewCellpop
////                    
...
////                    if favoriteItem.ItemOffer?.offerTitle != "" {
////                        cell.offerLabel.text = favoriteItem.ItemOffer?.offerTitle ?? ""
