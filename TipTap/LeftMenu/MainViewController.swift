...
//        view.addGestureRecognizer(tapGestureRecognizer)
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "TabOneNav")
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TabOneNav")
