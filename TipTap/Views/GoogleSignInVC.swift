...
////            convertImageToBase64(from: imageURL) { base64String in
////                if let base64String = base64String {
////                    base64Image = base64String
////                    print("Base64-encoded image string: \(base64String)")
////                } else {
...
////        }
////        fetchUserData(email: emailAddress) { [weak self] userData in
...
////                self?.postUserData(firstName: fullName, lastName: familyName, email: emailAddress, userImage: base64Image)
////            }
////        }
////    }
//    func handleSignInSuccess(user: GIDGoogleUser) {
...
//
//        if let imageURL = URL(string: profilePicUrl) {
//            convertImageToBase64(from: imageURL) { [weak self] base64String in
//                guard let base64Image = base64String else {
//                    print("Failed to convert image to Base64.")
//                    return
//                }
//                print("Base64-encoded image string: \(base64Image)")
